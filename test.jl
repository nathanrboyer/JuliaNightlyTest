...
# Read Data
(s_op, σ_op, s_op_units, σ_op_units) = read_fracture_stress("OperatingStress.csv")
(s_res, σ_res, s_res_units, σ_res_units) = read_fracture_stress("ResidualStress.csv")
